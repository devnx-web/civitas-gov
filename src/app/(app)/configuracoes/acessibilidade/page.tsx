    ...
    <main id="main-content" className="mx-auto max-w-3xl space-y-8 p-6">
      ...
      <section className="space-y-3 rounded-xl border border-ink-200 bg-white p-6 dark:border-ink-800 dark:bg-ink-950">
        ...
        <p className="text-sm text-ink-600 dark:text-ink-400">
          ...
          <strong>Civitas Gov</strong> seja acessível a todas as pessoas, independentemente de suas
          capacidades ou tecnologias assistivas utilizadas.
        </p>
        <p className="text-sm text-ink-600 dark:text-ink-400">
          Esta plataforma foi desenvolvida para estar em conformidade com as{" "}
          <strong>Diretrizes de Acessibilidade para Conteúdo Web (WCAG) 2.1, nível AA</strong>,
          conforme estabelecido pelo World Wide Web Consortium (W3C) e em alinhamento com o{" "}
      ...
      <section className="space-y-3 rounded-xl border border-ink-200 bg-white p-6 dark:border-ink-800 dark:bg-ink-950">
        ...
        <ul className="space-y-2 text-sm text-ink-600 dark:text-ink-400">
          <li className="flex items-start gap-2">
            ...
            <span>
              <strong>Link de pular conteúdo</strong> — disponível no topo de cada página para
              usuários de leitores de tela e navegação por teclado.
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="mt-0.5 h-4 w-4 flex-shrink-0 rounded-full bg-emerald-100 text-center text-[10px] font-bold leading-4 text-emerald-600">
            ...
            <span>
              ...
              <code className="rounded bg-ink-100 px-1 dark:bg-ink-800">pt-BR</code> para
              identificação correta do idioma por tecnologias assistivas.
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="mt-0.5 h-4 w-4 flex-shrink-0 rounded-full bg-emerald-100 text-center text-[10px] font-bold leading-4 text-emerald-600">
          ...
          <li className="flex items-start gap-2">
            ...
            <span>
              <strong>Contraste de cores</strong> — proporção mínima de 4,5:1 para texto normal e
          ...
          <li className="flex items-start gap-2">
            ...
            <span>
              <strong>Suporte a tema escuro</strong> — modo escuro disponível para redução de fadiga
              visual.
            </span>
          </li>
        </ul>
      ...
      <section className="space-y-3 rounded-xl border border-ink-200 bg-white p-6 dark:border-ink-800 dark:bg-ink-950">
        ...
        <p className="text-sm text-ink-600 dark:text-ink-400">
          Embora busquemos conformidade plena com WCAG 2.1 AA, algumas áreas estão em processo de
          melhoria contínua:
        </p>
      ...
      <section className="space-y-3 rounded-xl border border-brand-200 bg-brand-50/50 p-6 dark:border-brand-900 dark:bg-brand-900/10">
        ...
        <p className="text-sm text-ink-600 dark:text-ink-400">
          Encontrou alguma barreira de acessibilidade? Informe-nos. Nos comprometemos a responder em
      ...
      <section className="space-y-2 rounded-xl border border-ink-200 bg-white p-6 dark:border-ink-800 dark:bg-ink-950">
        ...
        <p className="text-sm text-ink-600 dark:text-ink-400">
          Esta declaração foi elaborada em <strong>19 de maio de 2026</strong> e será revisada
          anualmente ou sempre que houver alterações significativas na plataforma.
        </p>
        <p className="text-sm text-ink-600 dark:text-ink-400">
          <strong>Padrão adotado:</strong> WCAG 2.1, Nível AA
        </p>
        <p className="text-sm text-ink-600 dark:text-ink-400">
          <strong>Referência nacional:</strong> eMAG 3.1 — Modelo de Acessibilidade em Governo
          Eletrônico
        </p>
      </section>
    </main>
