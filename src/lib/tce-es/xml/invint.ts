/**
 * Gerador INVINT — Inventário de Bens Intangíveis
 * TCE-ES IN 43/2017
 */
...
export async function gerarINVINT({
  tenantId,
  ano,
  ...
  for (const bem of bens) {
    ...
    if (!bem.contaContabilId) {
      alertas.push(`INVINT: Bem intangível ${bem.numeroTombamento} sem conta contábil vinculada.`);
    }
